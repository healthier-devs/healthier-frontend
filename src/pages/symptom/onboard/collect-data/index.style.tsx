...
export const Button = styled.div<{ clickable: boolean }>`
  ...
  background-color: ${({ theme, clickable }) => (clickable ? theme.color.blue : theme.color.grey_650)};
  color: ${({ theme, clickable }) => (clickable ? theme.color.grey_100 : theme.color.grey_500)};
  font-size: 1.6rem;
  font-weight: 300;
  line-height: 150%;
  box-sizing: border-box;
